...
COPY ["backend/TaskConnect.NoteService.Core/TaskConnect.NoteService.Core.csproj", "TaskConnect.NoteService.Core/"]
...
COPY ["backend/TaskConnect.NoteService.Core/", "TaskConnect.NoteService.Core/"]
