...
namespace eztalo.TaskService.Infrastructure.Migrations
{
    ...
    [Migration("20250512035838_AddMindmapEntity")]
    partial class AddMindmapEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eztalo.TaskService.Domain.Entities.ChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eztalo.TaskService.Domain.Entities.Mindmap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("eztalo.TaskService.Domain.Entities.ChecklistItem", b =>
                {
                    b.HasOne("eztalo.TaskService.Domain.Entities.Note", "Note")
