...
# Unseal Vault
curl --request PUT --data "{\"key\": \"$KEY1\"}" http://vault:8200/v1/sys/unseal
curl --request PUT --data "{\"key\": \"$KEY2\"}" http://vault:8200/v1/sys/unseal
curl --request PUT --data "{\"key\": \"$KEY3\"}" http://vault:8200/v1/sys/unseal
